...
export class AppComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    ngOnInit() {
        ...
        this.menuService.itens = [
            { label: 'Homepage', icon: 'home', routerLink: ['/'] },
            { label: 'Manter Tarefa', icon: 'content_paste', routerLink: ['/tarefas'] },
            { label: 'Manter Responsavel', icon: 'person', routerLink: ['/responsaveis'] }
        ];
    }
